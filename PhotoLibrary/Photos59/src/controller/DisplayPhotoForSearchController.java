 ...
 * @author Karl Xu
 * 
 * DisplayPhotoForSearchController to broker between front-end and back-end for display photo for search
 */
public class DisplayPhotoForSearchController extends Application
{
	/**
	...
	/**
	 * selectedAlbumName is the album name for the photo being displayed now
	 */
	...
	public void start(Stage stage)
	{
		...
		selectedPhoto = SearchResultsController.getSelectedPhoto();
