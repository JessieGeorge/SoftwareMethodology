 ...
 * @author Karl Xu
 *
 * CreateAlbumController to broker between front-end and back-end for create album
 */
public class CreateAlbumController extends Application
{
	/**
	...
	private void clickedDone(ActionEvent event)
	{
		...
		//CALL KARL'S METHOD TO CREATE ALBUM
		UserList.currentUser.createAlbum(albumNameStr);
