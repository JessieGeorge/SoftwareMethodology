...
public abstract class ChessPiece {
	...
	public int enPassantCounter = 0;
	public int undoCounter = 0;
	public int undoCounter2 = 0;
	...
	public abstract boolean isThreatenMove(int fromRow, int fromCol, int toRow, int toCol);

	public abstract Move getLegalMove(int row, int col);
}
